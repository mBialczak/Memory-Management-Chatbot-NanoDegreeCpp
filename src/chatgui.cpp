    ...
    : wxFrame(NULL, wxID_ANY, title, wxDefaultPosition, wxSize(width, height))
{
  ...
  _userTextCtrl = new wxTextCtrl(ctrlPanel, idTextXtrl, "", wxDefaultPosition,
      wxSize(width, 50), wxTE_PROCESS_ENTER, wxDefaultValidator,
      wxTextCtrlNameStr);
    ...
    : wxScrolledWindow(parent, id)
{
  ...
  // _chatLogic = new ChatLogic(); //TODO: removed during task 1
...
ChatBotPanelDialog::~ChatBotPanelDialog()
{
  ...
  // delete _chatLogic; TODO: removed during task 1 (not needed after unique
  // pointer used)
